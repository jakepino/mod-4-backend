...
post1 = Post.create(likes: 0, user_id: joey.id, plant_id: plant1.id, comment_id: nil, description: "This is my snake plant! His name is Luxorlicious")
post2 = Post.create(likes: 2, user_id: jake.id, plant_id: plant2.id, comment_id: nil, description: "I don't know what this is. Someone help me")
...
com = Comment.create(post_id: joey.id, text: "yesir")